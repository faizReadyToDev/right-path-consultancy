                    ...
                    <div className="absolute top-10 items-center w-[100vw]">
                        <div className="items-center flex justify-center">
                            <div className=" inline-block mb-5 shadow-xl rounded-full border-2 border-slate-300">
                                <img className="w-[6vw]  max-sm:w-[20vw]" src="img/jobs-8.png" alt="" />
                            </div>
                        </div>
                        <div className="items-center">
                            <h2 className=" text-[#696c89] text-xl font-semibold text-center mb-5 max-sm:text-lg">Datamark</h2>
                            <h1 className="text-3xl font-semibold text-[#2f00fefe] text-center max-sm:text-xl">Data Analyst</h1>
                        </div>
                        <div className="border-b border-t border-slate-300 pb-5 flex gap-15 text-lg items-center justify-center mt-5 pt-5 max-sm:flex-col max-sm:gap-5">
                                    <div className="flex gap-2 items-center">
                                        ...
                                        <h1 className=" text-[#2f00fefe]" >Pune, India
                                        </h1>
                                    </div>
                                    <div className="flex gap-2 items-center">
                                        <img className="w-[1vw] h-[2vh] max-sm:w-[5vw]" src="img/money-jobs.png" alt="" />
                                        <h1 className=" text-[#2f00fefe]">₹50K Monthly</h1>
                                    </div>
                                    <div className="flex gap-2 items-center">
                                    ...
                                    <img src="img/briefcase.png" alt="" />
                                        <h1 className=" text-[#2f00fefe]">3+ Years Experience</h1>
                                    </div>
                                </div>
                        ...
                        <div>
                            ...
                            <div className=" pb-5 text-lg items-center pt-5">
                                    ...
                                    <div className="">
                                        ...
                                        <div className="ml-8 text-[#2f00fefe] ">Pune, India</div>
                                    </div>
                                    <div className="">
                                    ...
                                    <div className="">
                                        ...
                                        <div className="ml-8 text-[#2f00fefe] ">Data Analyst</div>
                                    </div>
                                    <div className="">
                                        <div className="flex gap-2 items-center  pt-5">
                                        ...
                                        <div className="ml-8 text-[#2f00fefe] ">3+ Year Experience</div>
                                    </div>
                                    <div className="">
                                        <div className="flex gap-2 items-center  pt-5">
                                        ...
                                        <div className="ml-8 text-[#2f00fefe] ">₹50K Monthly</div>
                                    </div>
                                    <div className="mb-5">
                                        <div className="flex gap-2 items-center  pt-5">
                    ...
                    <div className="w-[45vw] max-sm:w-[90vw]">
                        <div>
                            ...
                            <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                                <h1 className="items-center flex justify-center gap-2"> <svg className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" fill="gray" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Competitive salary with hybrid work flexibility.</h1>
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Opportunity to work with a global leader in data solutions.Attractive benefits and incentives.</h1>
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Skill enhancement and growth opportunities.</h1>
                        ...
                        <div>
                            ...
                            <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                            As a <span className="font-semibold">Data Analyst </span> at Datamark, you will be responsible for analyzing large datasets, generating insights, and supporting decision-making processes. You will collaborate with cross-functional teams to deliver data-driven solutions.
                            </p>
                        </div>
                        <div>
                            <h1 className="text-[#2f00fefe] font-semibold text-xl mb-5 mt-10">
                            ...
                            <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Proven experience as a Data Analyst (3+ years).</h1>
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Proficiency in tools like Excel, SQL, Python, or R.</h1>
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Strong analytical and problem-solving skills.</h1>
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Excellent communication and presentation abilities.</h1>
                        ...
                        <div>
                            ...
                            <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                                ...
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Freshers or candidates with 3+ year of experience are welcome.</h1>
                            ...
                            <div className="grid grid-cols-3 max-sm:grid-cols-1">
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <h1 className="text-[#2f00fefe] font-semibold  mb-5">3+ Year</h1>
                                    </div>
                                </div>
                                <div>
                                    <div>
                                ...
                                <div>
                                    <div>
                                        ...
                                        <h1 className="text-[#2f00fefe] font-semibold  mb-5">Field Sales Executive</h1>
                                    </div>
                                    <div>
                                        <h1 className="text-[#696c89] font-semibold mt-5">Educational Background</h1>
                                        <h1 className="text-[#2f00fefe] font-semibold  mb-5">Bachelor’s or Master’s degree in Data Science, Statistics, or a related field.</h1>
                                    </div>
                                </div>
                        ...
                        <div>
                            ...
                            <p className="text-[#696c89]">Datamark is a leading provider of business process outsourcing services, specializing in data-driven solutions that empower global enterprises. With a focus on innovation and operational excellence, Datamark delivers tailored services to help businesses achieve success.</p>
                        </div>
                            ...
                            <div className="grid grid-cols-3 max-sm:grid-cols-1">
                                ...
                                <div>
                                    <div>
                                        ...
                                        <h1 className="text-[#2f00fefe] font-semibold  mb-5">www.datamark.net</h1>
                                    </div>
                                    <div>
