                    ...
                    <div className="absolute top-10 items-center w-[100vw]">
                        <div className="items-center flex justify-center">
                            <div className=" inline-block mb-5 shadow-xl rounded-full border-2 border-slate-300">
                                <img className="w-[6vw] max-sm:w-[20vw]" src="img/jobs-10.png" alt="" />
                            </div>
                        </div>
                        <div className="items-center">
                            <h2 className=" text-[#696c89] text-xl font-semibold text-center mb-5 max-sm:text-lg">Fresh Print</h2>
                            <h1 className="text-3xl font-semibold text-[#2f00fefe] text-center max-sm:text-xl">Printing Technician</h1>
                        </div>
                        <div className="border-b border-t border-slate-300 pb-5 flex gap-15 text-lg items-center justify-center mt-5 pt-5 max-sm:flex-col max-sm:gap-5">
                                    <div className="flex gap-2 items-center">
                                        ...
                                        <h1 className=" text-[#2f00fefe]" >Jaipur, India
                                        </h1>
                                    </div>
                                    <div className="flex gap-2 items-center">
                                    ...
                                    <img src="img/briefcase.png" alt="" />
                                        <h1 className=" text-[#2f00fefe]">1-3 Years Experience</h1>
                                    </div>
                                </div>
                        ...
                        <div>
                            ...
                            <div className=" pb-5 text-lg items-center pt-5">
                                    ...
                                    <div className="">
                                        ...
                                        <div className="ml-8 text-[#2f00fefe] ">Jaipur, India</div>
                                    </div>
                                    <div className="">
                                    ...
                                    <div className="">
                                        ...
                                        <div className="ml-8 text-[#2f00fefe] ">Printing Technician</div>
                                    </div>
                                    <div className="">
                                        <div className="flex gap-2 items-center  pt-5">
                    ...
                    <div className="w-[45vw] max-sm:w-[90vw] ">
                        <div>
                            ...
                            <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                                <h1 className="items-center flex justify-center gap-2"> <svg className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" fill="gray" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Competitive salary with opportunities for career growth.</h1>
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Hands-on experience with advanced printing technologies.</h1>
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Collaborative and supportive work environment.</h1>
                        ...
                        <div>
                            ...
                            <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                            As a <span className="font-semibold">Printing Technician </span> you will operate and maintain printing equipment, ensuring high-quality output for various printing jobs. Your expertise will contribute to delivering exceptional products to clients.
                            </p>
                        </div>
                        <div>
                            <h1 className="text-[#2f00fefe] font-semibold text-xl mb-5 mt-10">
                            ...
                            <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Set up and operate printing machines for production.</h1>
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Monitor printing processes to ensure quality standards.</h1>
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Perform routine maintenance on printing equipment.</h1>
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Troubleshoot technical issues and implement solutions.</h1>
                        ...
                        <div>
                            ...
                            <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> 1-3 years of experience in the printing industry..</h1>
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Knowledge of printing processes and equipment.</h1>
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Strong attention to detail and ability to meet deadlines.</h1>
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Basic mechanical and troubleshooting skills.</h1>
                            ...
                            <div className="grid grid-cols-3 max-sm:grid-cols-1">
                                ...
                                <div>
                                    <div>
                                        ...
                                        <h1 className="text-[#2f00fefe] font-semibold  mb-5">Printing Technician</h1>
                                    </div>
                                    <div>
                                        <h1 className="text-[#696c89] font-semibold mt-5">Educational Background</h1>
                                        <h1 className="text-[#2f00fefe] font-semibold  mb-5">Diploma in Printing Technology or relevant field.</h1>
                                    </div>
                                </div>
                        ...
                        <div>
                            ...
                            <p className="text-[#696c89]">Fresh Print is a leading printing solutions provider known for delivering high-quality printing services across diverse industries. With state-of-the-art equipment and a dedicated team, we help businesses bring their ideas to life.</p>
                        </div>
                            ...
                            <div className="grid grid-cols-3 max-sm:grid-cols-1">
                                ...
                                <div>
                                    <div>
                                        ...
                                        <h1 className="text-[#2f00fefe] font-semibold  mb-5">www.freshprints.com</h1>
                                    </div>
                                    <div>
