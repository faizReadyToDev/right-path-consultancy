                    ...
                    <div className="absolute top-20 left-90">
                        <div className="items-center flex justify-center">
                            <div className=" inline-block mb-5 shadow-xl rounded-full border-2 border-slate-300">
                                <img className="w-[6vw] " src="img/jobs-6.png" alt="" />
                            </div>
                        </div>
                        <div className="items-center">
                            <h2 className=" text-[#696c89] text-xl font-semibold text-center mb-5">Swiggy</h2>
                            <h1 className="text-3xl font-semibold text-[#2f00fefe] text-center">Operations Executive</h1>
                        </div>
                ...
                <div className="flex  w-[80vw] mx-auto mt-20 justify-evenly jobs-details">
                    ...
                    <div className="w-[45vw]">
                        ...
                        <div>
                            ...
                            <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Monitor daily operations to ensure efficiency.</h1>
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Coordinate with delivery executives and the support team</h1>
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Address operational challenges and ensure smooth workflows.</h1>
                        ...
                        <div>
                            ...
                            <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                                ...
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Experience in operations or logistics (1+ years).</h1>
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Strong organizational skills</h1>
