                    ...
                    <div className="absolute top-10 items-center w-[100vw]">
                        <div className="items-center flex justify-center">
                            <div className=" inline-block mb-5 shadow-xl rounded-full border-2 border-slate-300">
                                <img className="w-[6vw] max-sm:w-[20vw]" src="img/jobs-6.png" alt="" />
                            </div>
                        </div>
                        <div className="items-center">
                            <h2 className=" text-[#696c89] text-xl font-semibold text-center mb-5 max-sm:text-lg">Swiggy</h2>
                            <h1 className="text-3xl font-semibold text-[#2f00fefe] text-center max-sm:text-xl">Operations Executive</h1>
                        </div>
                        <div className="border-b border-t border-slate-300 pb-5 flex gap-15 text-lg items-center justify-center mt-5 pt-5 max-sm:flex-col max-sm:gap-5">
                                    <div className="flex gap-2 items-center">
                                        ...
                                        <h1 className=" text-[#2f00fefe]" >Chennai, India
                                        </h1>
                                    </div>
                                    <div className="flex gap-2 items-center">
                                        <img className="w-[1vw] h-[2vh] max-sm:w-[5vw]" src="img/money-jobs.png" alt="" />
                                        <h1 className=" text-[#2f00fefe]">₹30K Monthly</h1>
                                    </div>
                                    <div className="flex gap-2 items-center">
                                    ...
                                    <img src="img/briefcase.png" alt="" />
                                        <h1 className=" text-[#2f00fefe]">1+ Years Experience</h1>
                                    </div>
                                </div>
                ...
                <div className="flex  w-[80vw] mx-auto mt-20 justify-evenly jobs-details max-sm:w-[90vw]">
                        ...
                        <div>
                            ...
                            <div className=" pb-5 text-lg items-center pt-5">
                                    ...
                                    <div className="">
                                        ...
                                        <div className="ml-8 text-[#2f00fefe] ">Chennai, India</div>
                                    </div>
                                    <div className="">
                                    ...
                                    <div className="">
                                        ...
                                        <div className="ml-8 text-[#2f00fefe] ">Operations Executive</div>
                                    </div>
                                    <div className="">
                                        <div className="flex gap-2 items-center  pt-5">
                                        ...
                                        <div className="ml-8 text-[#2f00fefe] ">1+ Year Experience</div>
                                    </div>
                                    <div className="">
                                        <div className="flex gap-2 items-center  pt-5">
                    ...
                    <div className="w-[45vw] max-sm:w-[90vw]">
                        ...
                        <div>
                            ...
                            <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                            As a <span className="font-semibold">Operations Executive</span> at Swiggy, you will oversee and streamline delivery operations, ensuring timely deliveries and customer satisfaction.
                            </p>
                        </div>
                        <div>
                            <h1 className="text-[#2f00fefe] font-semibold text-xl mb-5 mt-10">
                            ...
                            <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Monitor daily operations to ensure efficiency.</h1>
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Coordinate with delivery executives and the support team</h1>
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Address operational challenges and ensure smooth workflows.</h1>
                        ...
                        <div>
                            ...
                            <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                                ...
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Experience in operations or logistics (1+ years).</h1>
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Strong organizational skills</h1>
                            ...
                            <div className="grid grid-cols-3 max-sm:grid-cols-1">
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <h1 className="text-[#2f00fefe] font-semibold  mb-5">1+ Years</h1>
                                    </div>
                                </div>
                                <div>
                                    <div>
                                ...
                                <div>
                                    <div>
                                        ...
                                        <h1 className="text-[#2f00fefe] font-semibold  mb-5">Operations Executive</h1>
                                    </div>
                                    <div>
                        ...
                        <div>
                            ...
                            <p className="text-[#696c89]">Swiggy is a leading online food delivery platform in India, connecting customers with their favorite restaurants through seamless technology and operations.</p>
                        </div>
                            ...
                            <div className="grid grid-cols-3 max-sm:grid-cols-1">
                                ...
                                <div>
                                    <div>
                                        ...
                                        <h1 className="text-[#2f00fefe] font-semibold  mb-5">www.swiggy.com</h1>
                                    </div>
                                    <div>
