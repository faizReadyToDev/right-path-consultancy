           ...
           <div className="relative">
               ...
               <div className="bg-[url('/img/main-bg.jpg')] h-[77vh] bg-center bg-no-repeat bg-cover relative brightness-[100%]  opacity-20 rounded-b-4xl"></div>
                ...
                <div className="sm:hidden 2xl:block max-sm:hidden">
                    ...
                    <div  className="bg-white absolute border border-white shadow-xl inline-block p-4 rounded-full rotate-[10deg] rotate-pic top-27 left-98">
                        <div>
                    ...
                    <div className="border bg-white border-white shadow-xl inline-block p-4 rounded-lg rotate-[20deg] absolute bottom-28 right-320 rotate-pic">
                    ...
                    <div className="border bg-white border-white shadow-xl inline-block p-4 rounded-full rotate-[-10deg] absolute bottom-[-40px] right-350 rotate-pic">
                    ...
                    {/* Dots */}
                    <div className="w-[2vw] bg-pink-500 text-pink-500 rounded-full p-4 absolute bottom-[-75px] left-[430px] hover-balls">
        
                    </div>
                    <div className="w-[1.5vw] bg-green-500  rounded-full p-3 absolute top-45 left-10 hover-balls">
                    
                    </div>
                    <div className="w-[1vw] bg-yellow-500 text-pink-500 rounded-full p-3 absolute top-20 left-76 hover-balls">
                    
                    </div>
                    <div className="w-[.5vw] bg-red-500 text-pink-500 rounded-full p-2 absolute bottom-0 left-65 hover-balls">
                ...
                <div className="sm:hidden 2xl:block max-sm:hidden">
                    ...
                    <div className="border border-white shadow-xl bg-white inline-block p-5 rounded-full rotate-[-30deg] absolute top-50 right-50 rotate-pic">
                    ...
                    <div className="border bg-white border-white shadow-xl inline-block p-4 rounded-lg rotate-[20deg] absolute bottom-[-40px] right-70 rotate-pic">
                    ...
                    <div className="border bg-white border-white shadow-xl inline-block p-4 rounded-lg rotate-[-20deg] absolute top-28 right-98 rotate-pic">
                    ...
                    <div className="w-[1.5vw] bg-purple-700 text-pink-500 rounded-full p-3 absolute top-50 right-10 hover-balls">
                    
                    </div>
                    <div className="w-[1.5vw] bg-yellow-500  rounded-full p-3  absolute top-45 hover-balls">
                    
                    </div>
                    <div className="w-[1vw] bg-green-500 text-pink-500 rounded-full p-3 absolute top-15 right-60 hover-balls">
                    
                    </div>
                    <div className="w-[.5vw] bg-red-500 text-pink-500 rounded-full p-2 absolute bottom-[10px] right-40 hover-balls">
