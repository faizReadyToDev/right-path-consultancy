...
const Services = () => {
    ...
    return (
        ...
        <div className="bg-[url('/img/main-bg.jpg')] max-sm:h-[30vh] sm:h-[50vh] bg-center bg-no-repeat bg-cover relative brightness-[100%]  opacity-20 rounded-b-4xl"></div>
                ...
                <div className="col-span-2 max-2xl:col-span-full items-center justify-center justify-items-center max-2xl:w-[100vw]">
                    <div className="text-center text-[#2f00fefe]">
                        <h1 className="mt-15 text-6xl font-bold max-sm:text-3xl max-sm:mt-10 sm:mb-5">Services</h1>
                       
                        <h3 className="mb-20 text-gray-600 text-md max-sm:mt-0 max-sm:text-md max-sm:m-5 max-2xl:w-[60vw] max-2xl:mx-auto max-sm:w-[80vw] max-sm:mx-auto">These services aim to support Human Resources in managing their workforce effectively and efficiently.</h3>
                    </div >
            ...
            <div className="w-[35vw] mx-auto text-center mt-10 max-sm:w-[80vw] max-sm:mx-auto max-sm:text-center">
            ...
            <div className="sm:p-20 grid xl:grid-cols-3 gap-10 max-sm:block max-sm:p-0 max-sm:mt-10 sm:grid-cols-2 max-sm:grid-cols-1">
                <div className="p-4 border border-slate-300 lg:w-[28vw] max-sm:w-[80vw] max-sm:mx-auto rounded-lg box-shadow mt-5">
                <div className="p-2 bg-[#2f00fefe] inline-block">
                    <svg className="md:w-[1vw] sm:w-[2vw] max-sm:w-[5vw]"  viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg"><path fill="white" d="M128 352H32c-17.67 0-32 14.33-32 32v96c0 17.67 14.33 32 32 32h96c17.67 0 32-14.33 32-32v-96c0-17.67-14.33-32-32-32zm-24-80h192v48h48v-48h192v48h48v-57.59c0-21.17-17.23-38.41-38.41-38.41H344v-64h40c17.67 0 32-14.33 32-32V32c0-17.67-14.33-32-32-32H256c-17.67 0-32 14.33-32 32v96c0 17.67 14.33 32 32 32h40v64H94.41C73.23 224 56 241.23 56 262.41V320h48v-48zm264 80h-96c-17.67 0-32 14.33-32 32v96c0 17.67 14.33 32 32 32h96c17.67 0 32-14.33 32-32v-96c0-17.67-14.33-32-32-32zm240 0h-96c-17.67 0-32 14.33-32 32v96c0 17.67 14.33 32 32 32h96c17.67 0 32-14.33 32-32v-96c0-17.67-14.33-32-32-32z"></path></svg>
                </div>
                ...
                <div className="p-4 border border-slate-300 lg:w-[28vw] max-sm:w-[80vw] max-sm:mx-auto rounded-lg box-shadow mt-5">
                <div className="p-2 bg-[#2f00fefe] inline-block">
                    <svg className="md:w-[1vw] sm:w-[2vw] max-sm:w-[5vw]" viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg"><path fill=
                ...
                <div className="p-4 border border-slate-300 lg:w-[28vw] max-sm:w-[80vw] max-sm:mx-auto rounded-lg box-shadow mt-5">
                <div className="p-2 bg-[#2f00fefe] inline-block">
                    <svg className="md:w-[1vw] sm:w-[2vw] max-sm:w-[5vw]" viewBox="0 0 576 512" xmlns="http://www.w3.org/2000/svg"><path fill="white" d="M416 192c0-88.4-93.1-160-208-160S0 103.6 0 192c0 34.3 14.1 65.9 38 92-13.4 30.2-35.5 54.2-35.8 54.5-2.2 2.3-2.8 5.7-1.5 8.7S4.8 352 8 352c36.6 0 66.9-12.3 88.7-25 32.2 15.7 70.3 25 111.3 25 114.9 0 208-71.6 208-160zm122 220c23.9-26 38-57.7 38-92 0-66.9-53.5-124.2-129.3-148.1.9 6.6 1.3 13.3 1.3 20.1 0 105.9-107.7 192-240 192-10.8 0-21.3-.8-31.7-1.9C207.8 439.6 281.8 480 368 480c41 0 79.1-9.2 111.3-25 21.8 12.7 52.1 25 88.7 25 3.2 0 6.1-1.9 7.3-4.8 1.3-2.9.7-6.3-1.5-8.7-.3-.3-22.4-24.2-35.8-54.5z"></path></svg>
                    </div>
                ...
                <div className="p-4 border border-slate-300 lg:w-[28vw] max-sm:w-[80vw] max-sm:mx-auto rounded-lg box-shadow mt-5">
                <div className="p-2 bg-[#2f00fefe] inline-block">
                <svg className="md:w-[1vw] sm:w-[2vw] max-sm:w-[5vw]" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path fill="white" d="M505.04 442.66l-99.71-99.69c-4.5-4.5-10.6-7-17-7h-16.3c27.6-35.3 44-79.69 44-127.99C416.03 93.09 322.92 0 208.02 0S0 93.09 0 207.98s93.11 207.98 208.02 207.98c48.3 0 92.71-16.4 128.01-44v16.3c0 6.4 2.5 12.5 7 17l99.71 99.69c9.4 9.4 24.6 9.4 33.9 0l28.3-28.3c9.4-9.4 9.4-24.59.1-33.99zm-297.02-90.7c-79.54 0-144-64.34-144-143.98 0-79.53 64.35-143.98 144-143.98 79.54 0 144 64.34 144 143.98 0 79.53-64.35 143.98-144 143.98zm.02-239.96c-40.78 0-73.84 33.05-73.84 73.83 0 32.96 48.26 93.05 66.75 114.86a9.24 9.24 0 0 0 14.18 0c18.49-21.81 66.75-81.89 66.75-114.86 0-40.78-33.06-73.83-73.84-73.83zm0 96c-13.26 0-24-10.75-24-24 0-13.26 10.75-24 24-24s24 10.74 24 24c0 13.25-10.75 24-24 24z"></path></svg>
                </div>
                ...
                <div className="p-4 border border-slate-300 lg:w-[28vw] max-sm:w-[80vw] max-sm:mx-auto rounded-lg box-shadow mt-5 max-sm:mb-10">
                <div className="p-2 bg-[#2f00fefe] inline-block">
                <svg className="md:w-[1vw] sm:w-[2vw] max-sm:w-[5vw]" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path fill="white" d="M109.46 244.04l134.58-134.56-44.12-44.12-61.68 61.68a7.919 7.919 0 0 1-11.21 0l-11.21-11.21c-3.1-3.1-3.1-8.12 0-11.21l61.68-61.68-33.64-33.65C131.47-3.1 111.39-3.1 99 9.29L9.29 99c-12.38 12.39-12.39 32.47 0 44.86l100.17 100.18zm388.47-116.8c18.76-18.76 18.75-49.17 0-67.93l-45.25-45.25c-18.76-18.76-49.18-18.76-67.95 0l-46.02 46.01 113.2 113.2 46.02-46.03zM316.08 82.71l-297 296.96L.32 487.11c-2.53 14.49 10.09 27.11 24.59 24.56l107.45-18.84L429.28 195.9 316.08 82.71zm186.63 285.43l-33.64-33.64-61.68 61.68c-3.1 3.1-8.12 3.1-11.21 0l-11.21-11.21c-3.09-3.1-3.09-8.12 0-11.21l61.68-61.68-44.14-44.14L267.93 402.5l100.21 100.2c12.39 12.39 32.47 12.39 44.86 0l89.71-89.7c12.39-12.39 12.39-32.47 0-44.86z"></path></svg>
                </div>
