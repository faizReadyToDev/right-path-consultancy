        ...
        <div className="bg-[url('/img/main-bg.jpg')] h-[50vh] bg-center bg-no-repeat bg-cover relative brightness-[100%]  opacity-20 rounded-b-4xl"></div>
            ...
            <div className="col-span-2">
                <div className="text-center text-[#2f00fefe]">
                    <h1 className="mt-20 text-6xl font-bold mb-5">Contact Us</h1>
                    <h3 className="mb-20 text-gray-600 text-md">With over 20 years of experience, we can deliver great results to assist your HR Management with additional commitment.</h3>
                </div >
