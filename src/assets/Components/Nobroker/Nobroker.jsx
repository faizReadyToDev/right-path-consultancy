            ...
            <div className="absolute top-20 left-90">
                <div className="items-center flex justify-center">
                    <div className=" inline-block mb-5 shadow-xl rounded-full border-2 border-slate-300">
                        <img className="w-[6vw] " src="img/jobs-4.png" alt="" />
                    </div>
                </div>
                <div className="items-center">
                    <h2 className=" text-[#696c89] text-xl font-semibold text-center mb-5">Nobroker</h2>
                    <h1 className="text-3xl font-semibold text-[#2f00fefe] text-center">Sales Consultant</h1>
                </div>
                <div className="border-b border-t border-slate-300 pb-5 flex gap-15 text-lg items-center justify-center mt-5 pt-5">
                            <div className="flex gap-2 items-center">
                                ...
                                <h1 className=" text-[#2f00fefe]" >Bengaluru, India
                                </h1>
                            </div>
                            <div className="flex gap-2 items-center">
                                <img className="w-[1vw] h-[2vh]" src="img/money-jobs.png" alt="" />
                                <h1 className=" text-[#2f00fefe]">₹35K Monthly</h1>
                            </div>
                            <div className="flex gap-2 items-center">
                                <img src="img/hourglass.png" alt="" />
                                <h1 className=" text-[#2f00fefe]">Full-Time (Hybrid)</h1>
                            </div>
                            <div className="flex gap-2 items-center">
                            <img src="img/briefcase.png" alt="" />
                                <h1 className=" text-[#2f00fefe]">1-2 Year Experience</h1>
                            </div>
                        </div>
                ...
                <div>
                    ...
                    <div className=" pb-5 text-lg items-center pt-5">
                            ...
                            <div className="">
                                ...
                                <div className="ml-8 text-[#2f00fefe] ">Full-Time (Hybrid)</div>
                            </div>
                            <div className="">
                                <div className="flex gap-2 items-center  pt-5">
                                ...
                                <div className="ml-8 text-[#2f00fefe] ">Sales Consultant</div>
                            </div>
                            <div className="">
                                <div className="flex gap-2 items-center  pt-5">
                                ...
                                <div className="ml-8 text-[#2f00fefe] ">1-2 Year Experience</div>
                            </div>
                            <div className="">
                                <div className="flex gap-2 items-center  pt-5">
                                ...
                                <div className="ml-8 text-[#2f00fefe] ">₹35K Monthly</div>
                            </div>
                            <div className="mb-5">
                                <div className="flex gap-2 items-center  pt-5">
            ...
            <div className="w-[45vw]">
                <div>
                    ...
                    <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                        <h1 className="items-center flex justify-center gap-2"> <svg className="w-[0.4vw]" viewBox="0 0 612 512" fill="gray" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Hybrid work model with flexible schedules.</h1>
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Attractive incentives based on performance.</h1>
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Comprehensive training and development opportunities.</h1>
                ...
                <div>
                    ...
                    <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                    As a <span className="font-semibold">Sales Consultant</span> at Nobroker, you will engage with customers, promote services, and generate leads to drive business growth. This role requires persuasive communication and a result-oriented approach.
                    </p>
                </div>
                <div>
                    <h1 className="text-[#2f00fefe] font-semibold text-xl mb-5 mt-10">
                    ...
                    <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Connect with prospective clients and understand their property needs.</h1>
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Promote Nobroker’s solutions to meet customer requirements.</h1>
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Follow up on leads and close sales efficiently.</h1>
                ...
                <div>
                    ...
                    <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Proven track record in sales success.</h1>
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Excellent verbal and written communication skills.</h1>
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Strong customer relationship-building abilities.</h1>
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Goal-oriented with self-motivated work ethic.</h1>
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Ability to understand and meet client needs.</h1>
                    ...
                    <div className="grid grid-cols-3">
                        <div>
                            ...
                            <div>
                                ...
                                <h1 className="text-[#2f00fefe] font-semibold  mb-5">1-2 Years</h1>
                            </div>
                        </div>
                        <div>
                            <div>
                            ...
                            <div>
                                ...
                                <h1 className="text-[#2f00fefe] font-semibold  mb-5">Full-Time (Hybrid)</h1>
                            </div>
                        </div>
                        <div>
                            <div>
                                <h1 className="text-[#696c89] font-semibold mt-5">Job Type</h1>
                                <h1 className="text-[#2f00fefe] font-semibold  mb-5">Sales Consultant</h1>
                            </div>
                            <div>
                                <h1 className="text-[#696c89] font-semibold mt-5">Educational Background</h1>
                                <h1 className="text-[#2f00fefe] font-semibold  mb-5">Bachlor's Degree</h1>
                            </div>
                        </div>
                ...
                <div>
                    ...
                    <p>Nobroker is India’s first property-tech platform simplifying real estate transactions. From rental solutions to buying and selling, Nobroker is transforming the property market.</p>
                </div>
                    ...
                    <div className="grid grid-cols-3">
                        ...
                        <div>
                            <div>
                                ...
                                <h1 className="text-[#2f00fefe] font-semibold  mb-5">www.nobroker.in</h1>
                            </div>
                            <div>
