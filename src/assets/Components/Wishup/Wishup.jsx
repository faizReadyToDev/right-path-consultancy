                    ...
                    <div className="absolute top-20 left-90">
                        <div className="items-center flex justify-center">
                            <div className=" inline-block mb-5 shadow-xl rounded-full border-2 border-slate-300">
                                <img className="w-[6vw] " src="img/jobs-9.png" alt="" />
                            </div>
                        </div>
                        <div className="items-center">
                            <h2 className=" text-[#696c89] text-xl font-semibold text-center mb-5">Wishup</h2>
                            <h1 className="text-3xl font-semibold text-[#2f00fefe] text-center">Virtual Assistant</h1>
                        </div>
                    ...
                    <div className="w-[45vw]">
                        <div>
                            ...
                            <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                                <h1 className="items-center flex justify-center gap-2"> <svg className="w-[0.4vw]" viewBox="0 0 612 512" fill="gray" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> 100% remote work flexibility.</h1>
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Work with clients from around the globe.</h1>
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Opportunities to enhance productivity and communication skills.</h1>
                        ...
                        <div>
                            ...
                            <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Manage calendars, appointments, and emails for clients.</h1>
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Conduct research and create reports as required.</h1>
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Provide customer service support via chat, email, or phone.</h1>
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Handle data entry, scheduling, and other administrative tasks.</h1>
                        ...
                        <div>
                            ...
                            <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Proven experience as a Virtual Assistant or similar role (2+ years).</h1>
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Strong organizational and time management skills.</h1>
                                <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Proficiency in tools like Google Workspace, Microsoft Office, and Zoom.</h1>
