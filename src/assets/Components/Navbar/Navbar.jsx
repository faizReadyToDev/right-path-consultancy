...
import { NavbarSliderButton } from "../NavbarSliderButton/NavbarSliderButton";
...
const Navbar = () => {
    ...
    return (
        <>
        {isNavVisible ? (<NavbarSliderButton  isNavVisible={isNavVisible}
...
<div className="flex justify-between shadow-xl py-6 px-16 bg-white rounded-t-full h-[16vh] items-center max-sm:h-[10vh] max-sm:rounded-t-2xl max-sm:p-0 max-sm:relative">
    ...
    <img onClick={() => setIsNavVisible(true)} className="lg:hidden w-[7vw] max-sm:visible max-sm:absolute max-sm:right-10 z-10" src="img/menu.png" alt="" />
