        ...
        <>
            ...
            <div className="col-span-2">
                <div className="text-center text-[#2f00fefe]">
                    <h1 className="mt-20 text-6xl font-bold mb-5">Jobs</h1>
                    <h3 className="mb-20 text-gray-600 text-md">See your opportunity in the highest job demand around the world and choose your job dream & make your future bright.</h3>
                </div >
            ...
            <div className="w-[90vw] mx-auto grid grid-cols-3 gap-10 mt-10"> 
                {
                jobs1.map((item,index) => (
                    <Link to={item.job1.link}>
                    <div className="p-9 inline-block border border-slate-300 rounded-lg box-shadow cursor-pointer" key={index}>
