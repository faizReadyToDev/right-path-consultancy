    ...
    return (
        <>
            ...
            <div className="">
                ...
                <div  className="bg-white absolute border border-white shadow-xl inline-block p-4 rounded-full rotate-[10deg] top-26 left-98">
                    <div>
            ...
            <div className="col-span-2">
                <div className="text-center text-[#2f00fefe]">
                    <h1 className="mt-20 text-6xl font-bold mb-5">About Us</h1>
                    <h3 className="mb-20 text-gray-600 text-md">At <span className="font-semibold">Right Path</span>, we are dedicated to empowering job seekers and employers by bridging the gap between talent and opportunity.</h3>
                </div >
            ...
            >
                ...
                <div className='bg-gray-100 w-[13vw] h-[55vh] rounded-t-full rounded-b-full pt-5 pb-5'>
                    ...
                    <div className='flex gap-5 justify-center'>
                        <img onClick={() => window.open(faizLinkedin, '_blank')} className='w-[2vw] cursor-pointer' src="img/linkedin-jobs.png" alt="" />
                        <img onClick={() => window.open(faizInsta, '_blank')} className='w-[2vw] cursor-pointer' src="img/ig.png" alt="" />
                    </div>
                </div>
                </SwiperSlide>
                <SwiperSlide
