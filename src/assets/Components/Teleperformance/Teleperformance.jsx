            ...
            <div className="absolute top-10 items-center w-[100vw]">
                <div className="items-center flex justify-center">
                    <div className=" inline-block mb-5 shadow-xl rounded-full border-2 border-slate-300">
                        <img className="w-[6vw] max-sm:w-[20vw]" src="img/jobs-5.png" alt="" />
                    </div>
                </div>
                <div className="items-center">
                    <h2 className=" text-[#696c89] text-xl font-semibold text-center mb-5 max-sm:text-lg">Teleperformance</h2>
                    <h1 className="text-3xl font-semibold text-[#2f00fefe] text-center max-sm:text-xl">Technical Support Specialist</h1>
                </div>
                <div className="border-b border-t border-slate-300 pb-5 flex gap-15 text-lg items-center justify-center mt-5 pt-5 max-sm:flex-col max-sm:gap-5">
                            <div className="flex gap-2 items-center">
                                ...
                                <h1 className=" text-[#2f00fefe]" >Hyderabad, India
                                </h1>
                            </div>
                            <div className="flex gap-2 items-center">
                                <img className="w-[1vw] h-[2vh] max-sm:w-[5vw]" src="img/money-jobs.png" alt="" />
                                <h1 className=" text-[#2f00fefe]">₹45K Monthly</h1>
                            </div>
                            <div className="flex gap-2 items-center">
                ...
                <div>
                    ...
                    <div className=" pb-5 text-lg items-center pt-5">
                            ...
                            <div className="">
                                ...
                                <div className="ml-8 text-[#2f00fefe] ">Hyderabad, India</div>
                            </div>
                            <div className="">
                            ...
                            <div className="">
                                ...
                                <div className="ml-8 text-[#2f00fefe] ">Technical Support Specialist</div>
                            </div>
                            <div className="">
                                <div className="flex gap-2 items-center  pt-5">
                            ...
                            <div className="">
                                ...
                                <div className="ml-8 text-[#2f00fefe] ">₹45K Monthly</div>
                            </div>
                            <div className="mb-5">
                                <div className="flex gap-2 items-center  pt-5">
            ...
            <div className="w-[45vw] max-sm:w-[90vw]">
                <div>
                    ...
                    <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                        <h1 className="items-center flex justify-center gap-2"> <svg className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" fill="gray" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Competitive salary with additional perks.</h1>
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Work with global technology brands.</h1>
                ...
                <div>
                    ...
                    <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                    As a <span className="font-semibold">Technical Support Specialist,</span> you will troubleshoot and resolve technical issues for customers, ensuring a seamless experience. Your expertise will help customers optimize their use of products and services.
                    </p>
                </div>
                <div>
                    <h1 className="text-[#2f00fefe] font-semibold text-xl mb-5 mt-10">
                    ...
                    <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Handle customer queries and technical concerns effectively.</h1>
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Provide step-by-step resolutions for troubleshooting.</h1>
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Escalate unresolved issues to senior teams when necessary.</h1>
                ...
                <div>
                    ...
                    <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Proven technical support experience (2+ years).</h1>
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Strong problem-solving and analytical skills.</h1>
                        ...
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Excellent verbal and written communication.</h1>
                    ...
                    <div className="grid grid-cols-3 max-sm:grid-cols-1">
                        ...
                        <div>
                            <div>
                                ...
                                <h1 className="text-[#2f00fefe] font-semibold  mb-5">Technical Support Specialist</h1>
                            </div>
                            <div>
                                <h1 className="text-[#696c89] font-semibold mt-5">Educational Background</h1>
                                <h1 className="text-[#2f00fefe] font-semibold  mb-5">Relevant Technical Degree</h1>
                            </div>
                        </div>
                ...
                <div>
                    ...
                    <p>Teleperformance is a global leader in customer experience management, delivering exceptional support solutions for industry-leading brands.</p>
                </div>
                    ...
                    <div className="grid grid-cols-3 max-sm:grid-cols-1">
                        ...
                        <div>
                            <div>
                                ...
                                <h1 className="text-[#2f00fefe] font-semibold  mb-5">www.teleperformance.com</h1>
                            </div>
                            <div>
