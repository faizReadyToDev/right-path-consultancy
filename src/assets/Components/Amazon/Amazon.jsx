...
const Amazon = () => {
    ...
    return (
        ...
        <div className="relative">
            ...
            {/* <div className="absolute top-20 left-90 max-sm:top-10 max-sm:left-[40px]">
                <div className="items-center flex justify-center">
                    <div className=" inline-block mb-5 shadow-xl rounded-full border-2 border-slate-300">
                        <img className="w-[6vw] max-sm:w-[20vw]" src="img/jobs-1.png" alt="" />
                    </div>
                </div>
                <div className="items-center">
                    <h2 className=" text-[#696c89] text-xl font-semibold text-center mb-5 max-sm:text-lg">Amazon</h2>
                    <h1 className="text-3xl font-semibold text-[#2f00fefe] text-center max-sm:text-xl">Customer Support Associate</h1>
                </div>
                <div className="border-b border-t border-slate-300 pb-5 flex gap-15 text-lg items-center justify-center mt-5 pt-5 max-sm:flex-col max-sm:gap-5">
                            <div className="flex gap-2 items-center">
                                ...
                                <h1 className=" text-[#2f00fefe]" >Bengaluru, India</h1>
                            </div>
                            <div className="flex gap-2 items-center">
                                <img className="w-[1vw] h-[2vh] max-sm:w-[5vw] " src="img/money-jobs.png" alt="" />
                                <h1 className=" text-[#2f00fefe]">₹30K Monthly
                                </h1>
                            </div>
                            <div className="flex gap-2 items-center">
                            ...
                            <img src="img/briefcase.png" alt="" />
                                <h1 className=" text-[#2f00fefe]">1-3 Experience</h1>
                            </div>
                        </div>
                ...
                <div>
                    ...
                    <div className=" pb-5 text-lg items-center pt-5">
                            ...
                            <div className="">
                                ...
                                <div className="ml-8 text-[#2f00fefe] ">₹30K Monthly</div>
                            </div>
                            <div className="mb-5">
                                <div className="flex gap-2 items-center  pt-5">
            ...
            <div className="w-[45vw] max-sm:w-[90vw]">
                <div>
                    ...
                    <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                        <h1 className="items-center flex justify-center gap-2"> <svg className="w-[0.4vw] max-sm:w-[2.5vw] " viewBox="0 0 612 512" fill="gray" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Work with a globally renowned organization.</h1>
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Flexible working hours.</h1>
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Comprehensive training and skill development opportunities.</h1>
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Competitive salary package.</h1>
                    </p>
                </div>
                <div>
                    ...
                    <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                    We are looking for a motivated <span className="font-semibold">Customer Support Associate</span> to join our team. You will assist customers with inquiries, resolve issues, and ensure a seamless experience for our valued clients. If you are passionate about customer service and thrive in a fast-paced environment, this role is for you.
                    </p>
                </div>
                <div>
                    <h1 className="text-[#2f00fefe] font-semibold text-xl mb-5 mt-10">
                    ...
                    <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Respond promptly to customer queries and concerns.</h1>
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Provide effective solutions and ensure customer satisfaction.</h1>
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Collaborate with cross-functional teams to address complex issues.</h1>
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Maintain accurate records of customer interactions.</h1>
                    </p>
                </div>
                <div>
                    <h1 className="text-[#2f00fefe] font-semibold text-xl mb-5 mt-10 ">
                    ...
                    <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Bachelor's Degree or equivalent.</h1>
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Strong communication and interpersonal skills.</h1>
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg> Proven experience in customer support (1-3 years preferred).</h1>
                        <h1 className="items-center flex justify-center gap-2"> <svg fill="gray" className="w-[0.4vw] max-sm:w-[2.5vw]" viewBox="0 0 612 512" xmlns="http://www.w3.org/2000/svg"><path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path></svg>Proficiency in problem-solving and multitasking. Why Join Amazon:</h1>
                    </p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p>At Amazon, we foster a collaborative and innovative work culture. Be a part of a team that values growth, learning, and excellence while contributing to the success of a global leader in e-commerce.</p>
                </div>
                    ...
                    <div className="grid grid-cols-3 max-sm:grid-cols-1">
                        ...
                        <div>
                            <div>
                                ...
                                <h1 className="text-[#2f00fefe] font-semibold  mb-5">www.amazon.in</h1>
                            </div>
                            <div>
