                    ...
                    <div className="absolute top-10 items-center w-[100vw]">
                        ...
                        <div className="border-b border-t border-slate-300 pb-5 flex gap-15 text-lg items-center justify-center mt-5 pt-5 max-sm:flex-col max-sm:gap-5">
                                    ...
                                    <img src="img/briefcase.png" alt="" />
                                        <h1 className=" text-[#2f00fefe]">0-1 Years Experience</h1>
                                    </div>
                                </div>
                ...
                <div className="flex  w-[80vw] mx-auto mt-20 justify-evenly jobs-details max-sm:w-[90vw] ">
                        ...
                        <div>
                            ...
                            <div className=" pb-5 text-lg items-center pt-5">
                                    ...
                                    <div className="">
                                        ...
                                        <div className="ml-8 text-[#2f00fefe] ">Kolkata, India</div>
                                    </div>
                                    <div className="">
                                    ...
                                    <div className="">
                                        ...
                                        <div className="ml-8 text-[#2f00fefe] ">Field Sales Executive</div>
                                    </div>
                                    <div className="">
                                        <div className="flex gap-2 items-center  pt-5">
                    ...
                    <div className="w-[45vw] max-sm:w-[90vw]">
                        ...
                        <div>
                            ...
                            <p className="items-center flex-col justify-items-start pl-10 text-[#696c89]">
                            As a <span className="font-semibold">Field Sales Executive</span> you will build relationships with restaurants, onboard them to Zomato’s platform, and ensure successful partnerships.
                            </p>
                        </div>
                        <div>
                            <h1 className="text-[#2f00fefe] font-semibold text-xl mb-5 mt-10">
                            ...
                            <div className="grid grid-cols-3 max-sm:grid-cols-1">
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <h1 className="text-[#2f00fefe] font-semibold  mb-5">0-1 Year</h1>
                                    </div>
                                </div>
                                <div>
                                    <div>
                        ...
                        <div>
                            ...
                            <p className="text-[#696c89]">Zomato is a global leader in restaurant discovery and food delivery, revolutionizing the dining experience for customers worldwide.</p>
                        </div>
                            ...
                            <div className="grid grid-cols-3 max-sm:grid-cols-1">
                                ...
                                <div>
                                    <div>
                                        ...
                                        <h1 className="text-[#2f00fefe] font-semibold  mb-5">www.zomato.com</h1>
                                    </div>
                                    <div>
